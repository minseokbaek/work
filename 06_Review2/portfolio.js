...
document.getElementById('all').addEventListener('mouseover', filterSelection.bind(null, 'all'));
document.getElementById('uiux').addEventListener('mouseover', filterSelection.bind(null, 'uiux'));
document.getElementById('java').addEventListener('mouseover', filterSelection.bind(null, 'java'));
document.getElementById('db').addEventListener('mouseover', filterSelection.bind(null, 'db'));
